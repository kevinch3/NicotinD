...
describe('StreamingMediaPanelComponent (TV D-pad navigation)', () => {
  it('streaming checkboxes get per-row groups; the selects stay outside every group (issue #396)', async () => {
    ...
    // transcode on-the-fly and the second transcoding checkbox — both D-pad
    // reachable inside their own row group. Was three until the ML
    // vocal-separation opt-in was removed (#1024).
