...
export class NowPlayingTransportComponent {
  /**
   * The TV fork is now only about the waveform above the row: the transport
   * itself has been prev/play/next everywhere since shuffle and repeat left
   * the UI (docs/web-ui.md "Shuffle and repeat are not in the UI"), which is
   * what the 10-foot build had always shown.
   */
