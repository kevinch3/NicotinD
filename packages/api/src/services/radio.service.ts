 ...
 * v5 - three composite descriptor axes (issue #642): timbre (21 z-scored
 ...
 *      the library (descriptor-norm.ts). The v1–v4 votes cannot grade v5 —
 *      their snapshots carry no blocks — so v5 needs its own poll.
 */
export const RADIO_FORMULA_VERSION = 5;
