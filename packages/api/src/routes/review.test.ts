  ...
  it('returns the full ServiceReview shape with all sub-fetches happy', async () => {
    const subFns = {
      ...
      processingSummary: mock(() => ({
        ...
        availability: { bpm: true as const, genre: true as const, key: true as const, energy: true as const, 'audio-features': true as const, 'artist-image': true as const, 'artist-identity': true as const, licence: true as const },
        startedAt: null,
        updatedAt: null,
      })),
