  ...
  it('returns the full ServiceReview shape with all sub-fetches happy', async () => {
    const subFns = {
      ...
      processingSummary: mock(() => ({
        ...
        skipped: 0,
        quarantined: 0,
        taskPending: { bpm: 0, genre: 0, key: 0, energy: 0, 'audio-features': 0, 'artist-image': 0, 'artist-info': 0, 'artist-identity': 0, licence: 0, 'genre-audio': 0 },
        availability: { bpm: true as const, genre: true as const, key: true as const, energy: true as const, 'audio-features': true as const, 'artist-image': true as const, 'artist-info': true as const, 'artist-identity': true as const, licence: true as const, 'genre-audio': true as const },
        startedAt: null,
        updatedAt: null,
      })),
