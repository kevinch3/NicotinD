...
- **Now Playing queue — clear + drag-reorder**: "Next up" supports a Clear link + HTML5 drag-and-drop row reorder backed by `PlayerService.clearQueue()` / `moveInQueue(from,to)`. → [docs/web-ui.md](docs/web-ui.md)
